...
export function Badge({ icon, label }: BadgeProps) {
  return (
    <a
      href="#"
      className="flex w-full items-center gap-3 rounded-md bg-zinc-100 p-3 shadow-sm shadow-zinc-100 transition-colors hover:bg-zinc-200/50 hover:transition-colors md:w-52"
    >
